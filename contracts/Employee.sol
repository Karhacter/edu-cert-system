...
contract Employee {
    ...
    function getCertificationByName(
        string memory _name
    ) private view returns (string memory, address, uint256, bool, bool) {
        return (
    ...
    function getCertificationByIndex(
        uint256 _index
    ) public view returns (string memory, address, uint256, bool, bool) {
    ...
    function getEducationByAddress(
        address _institute
    )
        private
        view
