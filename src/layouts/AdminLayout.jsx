      ...
      <header className="bg-[var(--card-bg)] border-b border-[var(--border-color)]">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4">
            ...
            <NavLink to="/admin/organizations" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>Organizations</NavLink>
            <NavLink to="/admin/lookup" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>Lookup</NavLink>
